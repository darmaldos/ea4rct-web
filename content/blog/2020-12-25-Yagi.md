...
Como paso previo a la redacción de esta entrada, cabe señalar que todos ficheros generados en el proceso (.cst, .stl, .freecad...) se encuentran disponibles en su [correspondiente repositorio de GiTea](https://github.com/WX-Ground-Station-RadioClub-E-I-T/yagi-137/blob/master/README.md).
